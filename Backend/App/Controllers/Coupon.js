...
class Coupon {
    ...
    async AddCoupon(req, res) {
        try {
          ...
          await new Promise((resolve, reject) => {
            ...
            const { name, code, type, value, startdate, enddate,add_by,minpurchasevalue,mincouponvalue,description,limitation } = req.body;
  ...
  async updateCoupon(req, res) {
    try {
      ...
      const { id, name, code, type, value, startdate, enddate,minpurchasevalue,mincouponvalue,description,limitation } = req.body;
