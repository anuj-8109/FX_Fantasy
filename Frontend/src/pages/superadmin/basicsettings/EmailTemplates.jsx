      ...
      {templates?.map((template) => (
        ...
        >
          <div className="flex items-start justify-between mb-4">
            <div>
              <p className="text-xs uppercase tracking-wide">Mail Type</p>
          ...
          <div className="mb-3">
            <p className="text-xs uppercase tracking-wide mb-1">Subject</p>
            <p className="text-sm font-medium">{template.mail_subject}</p>
          </div>

          <div>
            <p className="text-xs uppercase tracking-wide mb-1">Mail Body</p>
        ...
        <div className="w-full max-w-xl rounded-2xl shadow-2xl p-6 animate-fadeIn bg-white">
          ...
          {loading ? (
            ...
            <div className="space-y-5">
              {/* Mail Type */}
              <div>
                <label className="text-sm font-medium mb-1 block">Mail Type</label>
                <input
              ...
              {/* Mail Body */}
              <div>
                <label className="text-sm font-medium mb-1 block">Mail Body</label>
                <textarea
