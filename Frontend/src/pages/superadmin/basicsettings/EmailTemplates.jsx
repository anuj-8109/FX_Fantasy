      ...
      <div className="p-6  min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {templates?.map((template) => (
            <div
              key={template._id}
              className="bg-white border border-gray-200 rounded-2xl shadow-md p-5 flex flex-col transition hover:shadow-lg hover:scale-[1.01] duration-200"
            >
              ...
              {loading ? (
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <input
                      className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm bg-gray-100"
                      value={mailType}
                      readOnly
                    />
                  </div>
